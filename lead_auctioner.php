<?php 
    ...
    $str="SELECT la.*, a.name AS auction_name
        FROM lead_auc la
        JOIN auctions a ON la.aid = a.id";
...
<?php
    ...
    {   
        $id=$_GET['id'];
        $sql="delete from lead_auc where id=".$id."";
        mysqli_query($conn,$sql);
        header("location:lead_auctioner.php");
    }
?>
...
<head>
    <meta charset="utf-8" />
    <title>Lead Auctioner | CrickFolio</title>
        ...
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">    
                ...
                <div class="topbar-item d-none d-md-flex px-2">                 
                    <div>
                        <h4 class="page-title fs-20 fw-semibold mb-0">Lead Auctioner / Details</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">    
                            ...
                            <h4 class="header-title">Lead Auctioner Details</h4>
                            </div>                            
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="fa fa-trash fa-lg btn btn-danger" href="javascript:void(0);" onclick="confirmDelete(<?php echo $row['lid']; ?>)"></a> 
