<?php 
    ...
    $str = "SELECT so.id,o.name AS oname,se.name AS season_name, so.status,so.created_at
            FROM season_organizer so
            JOIN organizers o ON so.organizer_id = o.id
            JOIN seasons se ON so.season_id = se.id";
...
<?php
    ...
    {   
        $id=$_GET['id'];
        $sql="delete from season_organizer where id=".$id."";
        mysqli_query($conn,$sql);
        header("location:manage_season_organizer.php");
    }
?>
...
<head>
    <meta charset="utf-8" />
    <title>Manage Season Organizer | CrickFolio</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">    
                            ...
                            <h4 class="header-title">Season Organizer Details</h4>
                            </div>                            
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-table="season_organizer">    <!-- 👈 table name here -->
