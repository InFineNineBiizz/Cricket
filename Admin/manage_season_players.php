<?php 
    ...
    $str = "SELECT sp.id,se.name AS season_name,CONCAT(p.fname, ' ', p.lname) AS player_name,sp.created_at
...
<?php
    ...
    {   
        $id=$_GET['id'];
        $sql="delete from season_players where id=".$id."";
        mysqli_query($conn,$sql);
        header("location:manage_season_players.php");
    }
?>
        ...
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">    
                ...
                <div class="topbar-item d-none d-md-flex px-2">                 
                    <div>
                        <h4 class="page-title fs-20 fw-semibold mb-0">Season Players / Details</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">    
                            ...
                            <h4 class="header-title">Season Players Details</h4>
                            </div>                            
