<?php 
    ...
    $str = "SELECT ss.id,se.name AS season_name,sp.name AS sponsor_name,ss.created_at
...
<?php
    ...
    {   
        $id=$_GET['id'];
        $sql="delete from season_sponsors where id=".$id."";
        mysqli_query($conn,$sql);
        header("location:manage_season_sponsor.php");
    }
?>
...
<head>
    <meta charset="utf-8" />
    <title>Manage Season Sponsors | CrickFolio</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">    
                            ...
                            <h4 class="header-title">Season Sponsors Details</h4>
                            </div>                            
