...
<head>
    <meta charset="utf-8" />
    <title>Manage Teams | CrickFolio</title>
        ...
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">    
                ...
                <div class="topbar-item d-none d-md-flex px-2">                 
                    <div>
                        <h4 class="page-title fs-20 fw-semibold mb-0">Auction / Teams / Details</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom border-dashed">
                                <h4 class="card-title mb-0 flex-grow-1">Teams Details</h4>
                            </div>                       
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button class="statusBtn btn 
                                            ...
                                            data-table="teams">    <!--  table name here -->
