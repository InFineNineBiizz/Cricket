...
<head>
    <meta charset="utf-8" />
    <title>Manage Auctions | CrickFolio</title>
        ...
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">    
                ...
                <div class="topbar-item d-none d-md-flex px-2">                 
                    <div>
                        <h4 class="page-title fs-20 fw-semibold mb-0">Auction / Details</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">    
                            ...
                            <h4 class="header-title">Auctions Details</h4>
                            </div>                            
